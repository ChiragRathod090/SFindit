...
class Result {
  List<LadderDatum> ladderData;
  List<FixtureDatum> fixtureData;
  ...
  factory Result.fromMap(Map<String, dynamic> json) => Result(
        ladderData: List<LadderDatum>.from(
            json["ladderData"].map((x) => LadderDatum.fromMap(x))),
        fixtureData: List<FixtureDatum>.from(
            json["fixtureData"].map((x) => FixtureDatum.fromMap(x))),
      );
...
class FixtureDatum {
  ...
  factory FixtureDatum.fromMap(Map<String, dynamic> json) => FixtureDatum(
        matchId: json["match_id"],
        venue: venueValues.map[json["venue"]],
        home: json["home"],
        away: json["away"],
...
class LadderDatum {
  ...
  factory LadderDatum.fromMap(Map<String, dynamic> json) => LadderDatum(
        id: json["id"],
        did: json["did"],
        win: json["win"],
        loss: json["loss"],
